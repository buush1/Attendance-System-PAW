...
function createDatabaseAndTables($show_messages = false) {
    try {
        ...
        if ($show_messages) echo "<p style='color: green;'>✓ Database 'student_attendance' created successfully!</p>";
        ...
        if ($show_messages) echo "<p style='color: green;'>✓ Table 'students' created successfully!</p>";
        ...
        if ($show_messages) echo "<p style='color: green;'>✓ Table 'attendance_sessions' created successfully!</p>";
